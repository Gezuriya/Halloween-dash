...
public class SnapScrolling : MonoBehaviour
{
    ...
    public GameObject[] panPrefabs; 
    public ScrollRect scrollRect;
    public GameObject panpref1, panpref2, panpref3, panpref4, panpref5;
    ...
    private void Start()
    {
        panPrefabs = new GameObject[5];
        panPrefabs[0] = panpref1;
        panPrefabs[1] = panpref2;
        panPrefabs[2] = panpref3;
        panPrefabs[3] = panpref4;
        panPrefabs[4] = panpref5;
        ...
        for (int i = 0; i < panCount; i++)
        {
            ...
            if (i == 0) continue;
            instPans[i].transform.localPosition = new Vector2(instPans[i - 1].transform.localPosition.x + panPrefabs[i].GetComponent<RectTransform>().sizeDelta.x + panOffset,
